...
@section('title', 'Tahun Kurikulum - Wadir 1')
@section('content')
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-600">Ringkasan tahun ajaran dan kurikulum yang digunakan pada program studi.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="px-6 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-1 text-xs md:text-sm text-blue-100">
                        Ringkasan seluruh tahun kurikulum aktif yang dapat dipantau oleh Wadir 1.
                    </p>
                </div>
