    ...
    <div class="max-w-5xl mx-auto">
        ...
        <div class="mb-6">
            ...
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h1 class="text-2xl md:text-3xl font-bold text-gray-900 tracking-tight">Edit Program Studi</h1>
                    <p class="mt-1 text-sm text-gray-600">
                        Perbarui informasi kode prodi, nama prodi, nama kaprodi, dan jenjang pendidikan.
                    </p>
                </div>
            </div>
        </div>
