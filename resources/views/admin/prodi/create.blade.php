    ...
    <div class="max-w-5xl mx-auto">
        ...
        <div class="mb-6">
            ...
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h1 class="text-2xl md:text-3xl font-bold text-gray-900 tracking-tight">Tambah Program Studi</h1>
                    <p class="mt-1 text-sm text-gray-600">
                        Tambahkan program studi baru beserta informasi kaprodi dan jenjang pendidikan.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="px-6 py-6">
                ...
                <form action="{{ route('admin.prodi.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2">
                            <label for="nama_prodi" class="block text-sm font-semibold text-gray-800">
                                Nama Prodi
                            </label>
                        ...
                        <div class="space-y-2">
                            <label for="nama_kaprodi" class="block text-sm font-semibold text-gray-800">
                                Nama Kaprodi
                            </label>
                        ...
                        <div class="space-y-2">
                            <label for="jenjang_pendidikan" class="block text-sm font-semibold text-gray-800">
                                Jenjang Pendidikan
                            </label>
                            <select name="jenjang_pendidikan" id="jenjang_pendidikan"
                                    class="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm text-gray-800 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                    required>
                                <option value="" disabled {{ old('jenjang_pendidikan') ? '' : 'selected' }}>Pilih Jenjang</option>
