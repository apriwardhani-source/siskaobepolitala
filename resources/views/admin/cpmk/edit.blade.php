<!-- resources/views/admin/cpmk/edit.blade.php -->
@extends('layouts.app')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="deskripsi" id="deskripsi" rows="4" required
                                  ...
                                  class="w-full glass-input py-2 px-4 rounded-lg focus:ring-2 focus:ring-blue-400 focus:border-transparent @error('deskripsi') !border-red-500 @enderror">{{ old('deskripsi', $cpmk->deskripsi) }}</textarea>
                        @error('deskripsi')
                            <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="bobot" id="bobot" value="{{ old('bobot', $cpmk->bobot) }}" min="0" max="100"
