        ...
        <form method="POST" action="{{ route('cpmk.store') }}" class="space-y-6">
            ...
            <div class="grid grid-cols-1 gap-6">
                <div>
                    ...
                    <input type="text" name="kode_cpmk" id="kode_cpmk" value="{{ old('kode_cpmk') }}" required placeholder="Contoh: CPMK1"
                ...
                <div>
                    ...
                    <textarea name="deskripsi" id="deskripsi" rows="4" required placeholder="Deskripsikan CPMK secara lengkap..."
                              class="w-full glass-input py-2 px-4 rounded-lg focus:ring-2 focus:ring-blue-400">{{ old('deskripsi') }}</textarea>
                </div>
            </div>
