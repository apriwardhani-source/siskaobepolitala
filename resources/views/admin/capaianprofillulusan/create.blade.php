    ...
    <div class="max-w-5xl mx-auto">
            ...
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-600">
                        Tambahkan CPL baru untuk program studi dan tahun kurikulum yang dipilih.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200">
            ...
            <div class="px-6 py-6">
                ...
                <form action="{{ route('admin.capaianprofillulusan.store') }}" method="POST" class="space-y-6">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <select id="kode_prodi" name="kode_prodi"
                                    ...
                                    required>
                                <option value="" disabled {{ old('kode_prodi') ? '' : 'selected' }}>Pilih Program Studi</option>
