            ...
            <div class="px-6 py-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        ...
                        <input type="text" id="kode_cpl" value="{{ $capaianprofillulusan->kode_cpl }}" readonly
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" id="status_cpl" value="{{ $capaianprofillulusan->status_cpl ?: '-' }}" readonly
                               class="w-full px-4 py-2.5 border border-gray-300 rounded-lg bg-gray-50 text-sm text-gray-800">
                    </div>
                    ...
                    <div class="space-y-2 md:col-span-2">
                        ...
                        <textarea id="deskripsi_cpl" rows="4" readonly
                                  class="w-full px-4 py-2.5 border border-gray-300 rounded-lg bg-gray-50 text-sm text-gray-800">{{ $capaianprofillulusan->deskripsi_cpl }}</textarea>
                    </div>
                </div>
