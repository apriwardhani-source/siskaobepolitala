        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200">
            <div class="px-6 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 flex items-center justify-between">
                ...
                <div class="text-xs text-blue-100">
                    Total Bobot: <span id="totalBobot" class="font-semibold text-white">{{ $totalBobot ?? 0 }}%</span>
                </div>
            </div>
            ...
            <div class="px-6 py-6">
                ...
                <form action="{{ route('admin.bobot.update', ['bobot' => $mk->kode_mk]) }}" method="POST" id="bobotForm" class="space-y-6">
                    @csrf
                    @method('PUT')
