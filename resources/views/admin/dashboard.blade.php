    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-6 px-4 sm:px-6 lg:px-8">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="mb-8">
                ...
                <p class="mt-2 text-sm text-gray-600">Progress implementasi kurikulum berbasis Outcome-Based Education per
                    Program Studi</p>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <div
                    class="bg-white rounded-xl shadow-lg overflow-hidden border-l-4 border-blue-500 transform hover:scale-105 transition-all duration-200">
                    <div class="p-6">
                        <div class="flex items-center justify-between">
                            <div class="flex-1">
                                <p class="text-sm font-medium text-gray-600 uppercase tracking-wider">Program Studi</p>
                ...
                <div
                    class="bg-white rounded-xl shadow-lg overflow-hidden border-l-4 border-green-500 transform hover:scale-105 transition-all duration-200">
                    <div class="p-6">
                        <div class="flex items-center justify-between">
                            <div class="flex-1">
                ...
                <div
                    class="bg-white rounded-xl shadow-lg overflow-hidden border-l-4 border-amber-500 transform hover:scale-105 transition-all duration-200">
                    <div class="p-6">
                        <div class="flex items-center justify-between">
                            <div class="flex-1">
                                <p class="text-sm font-medium text-gray-600 uppercase tracking-wider">Progress</p>
                ...
                <div
                    class="bg-white rounded-xl shadow-lg overflow-hidden border-l-4 border-red-500 transform hover:scale-105 transition-all duration-200">
                    <div class="p-6">
                        <div class="flex items-center justify-between">
                            <div class="flex-1">
                            ...
                            <div class="flex-shrink-0">
                                <div
                                    class="w-14 h-14 bg-gradient-to-br from-red-400 to-red-600 rounded-xl flex items-center justify-center shadow-lg">
            ...
            @if (request()->filled('tahun_progress'))
                <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <div class="bg-gradient-to-r from-gray-700 to-gray-800 px-6 py-5">
                        ...
                        <p class="mt-1 text-sm text-gray-300">Tahun Kurikulum:
                            {{ $availableYears->firstWhere('id_tahun', request('tahun_progress'))->tahun ?? '-' }}</p>
                    </div>

                    <div class="p-6">
                        <!-- Target Info Box -->
                        <div
                            class="bg-gradient-to-r from-blue-50 to-indigo-50 border-l-4 border-blue-500 rounded-lg p-5 mb-8">
                        ...
                        <div class="space-y-6">
                            @foreach ($prodis as $prodi)
                                <div
                                    class="prodi-card bg-gray-50 rounded-lg p-6 border border-gray-200 hover:border-blue-300 hover:shadow-md transition-all duration-200">
                                        ...
                                        <div class="flex items-center space-x-3">
                                            <span
                                                class="inline-flex items-center px-4 py-2 rounded-full text-sm font-semibold
                                                 {{ $prodi->avg_progress >= 80
                                                     ? 'bg-green-100 text-green-800'
                                                     : ($prodi->avg_progress >= 50
                                    ...
                                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                                        <div class="bg-white rounded-lg p-3 border border-blue-200">
                                            <div class="flex items-center justify-between mb-2">
                                                ...
                                                <span
                                                    class="text-xs font-semibold text-blue-600">{{ $prodi->progress_cpl }}%</span>
                                            </div>
                                            <div class="text-sm font-semibold text-gray-900">{{ $prodi->cpl_count }}/9
                                            </div>
                                        ...
                                        <div class="bg-white rounded-lg p-3 border border-amber-200">
                                            <div class="flex items-center justify-between mb-2">
                                                ...
                                                <span
                                                    class="text-xs font-semibold text-amber-600">{{ $prodi->progress_sks_mk }}%</span>
                                            </div>
                                            <div class="text-sm font-semibold text-gray-900">{{ $prodi->sks_mk }}/144
                                            </div>
                                        ...
                                        <div class="bg-white rounded-lg p-3 border border-orange-200">
                                            <div class="flex items-center justify-between mb-2">
                                                ...
                                                <span
                                                    class="text-xs font-semibold text-orange-600">{{ $prodi->progress_cpmk }}%</span>
                                            </div>
                                            <div class="text-sm font-semibold text-gray-900">{{ $prodi->cpmk_count }}/20
                                            </div>
                                        ...
                                        <div class="bg-white rounded-lg p-3 border border-red-200">
                                            <div class="flex items-center justify-between mb-2">
                                                ...
                                                <span
                                                    class="text-xs font-semibold text-red-600">{{ $prodi->progress_subcpmk }}%</span>
                                            </div>
                                            <div class="text-sm font-semibold text-gray-900">
                                                {{ $prodi->subcpmk_count }}/40</div>
