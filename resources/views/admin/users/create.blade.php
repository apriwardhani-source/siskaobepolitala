    ...
    <div class="max-w-5xl mx-auto">
        ...
        <div class="mb-6">
            ...
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h1 class="text-2xl md:text-3xl font-bold text-gray-900 tracking-tight">Tambah Pengguna</h1>
                    <p class="mt-1 text-sm text-gray-600">
                        Tambahkan akun pengguna baru beserta peran dan program studinya.
                    </p>
                </div>
            </div>
        </div>
