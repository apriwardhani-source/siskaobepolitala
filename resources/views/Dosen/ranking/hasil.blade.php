    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <a href="{{ route('dosen.ranking.index') }}" class="text-blue-600 hover:text-blue-800 text-sm font-medium mb-2 inline-block">
                        ← Kembali
                    </a>
                ...
                <div>
                    <a href="{{ route('dosen.ranking.export', $session->id_session) }}" 
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-blue-50 transition-colors 
                            ...
                            <td class="px-6 py-4 text-center">
                                <a href="{{ route('dosen.ranking.detail', [$session->id_session, $rank->nim]) }}" 
