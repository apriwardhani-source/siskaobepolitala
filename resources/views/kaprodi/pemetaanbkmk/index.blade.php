...
@section('content')
    <div class="bg-white p-4 md:p-6 lg:p-8 rounded-lg shadow-md mx-2 md:mx-0">
        ...
        <select id="tahun" name="id_tahun"
            class="border border-black px-4 py-2 rounded-md focus:outline-none focus:ring-2 mb-4 text-center focus:ring-green-500"
    ...
    <script>
        function updateFilter() {
            ...
            let url = "{{ route('kaprodi.pemetaanbkmk.index') }}";
