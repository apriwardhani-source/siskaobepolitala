...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-6 px-4 sm:px-6 lg:px-8">
    <div class="max-w-5xl mx-auto">
        ...
        <!-- Header selaras dengan detail tim -->
        <div class="mb-6">
            <a href="{{ route('kaprodi.bobot.index', ['id_tahun' => request('id_tahun')]) }}" 
                ...
                <div>
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <span class="text-xs text-gray-500">
                            Setiap baris menampilkan CPL yang dipetakan ke mata kuliah ini beserta bobotnya.
                        </span>
                    </div>
                    <div id="cplList"
