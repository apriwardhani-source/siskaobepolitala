...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-6 px-4 sm:px-6 lg:px-8">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200 mb-8">
            ...
            <div class="p-6">
                <form method="GET" action="{{ route('kaprodi.hasilobe.index') }}" class="space-y-4">
                    ...
                    <div class="pt-4 border-t border-gray-200">
                        <div class="flex flex-wrap gap-2 items-center">
                            ...
                            @endif
                            <a href="{{ route('kaprodi.hasilobe.index') }}" 
                ...
                <div class="divide-y divide-gray-200">
                    ...
                    <div class="mahasiswa-item hover:bg-blue-50 transition-colors duration-150">
                        <div class="px-6 py-4 flex items-center justify-between">
                            ...
                            <div>
                                <a href="{{ route('kaprodi.hasilobe.detail', $mahasiswa->nim) }}" 
