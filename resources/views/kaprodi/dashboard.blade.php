...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-6 px-4 sm:px-6 lg:px-8">
    <div class="max-w-7xl mx-auto">
        ...
        <!-- Header -->
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900 tracking-tight">Dashboard Kurikulum OBE - Kaprodi</h1>
            <p class="mt-2 text-sm text-gray-600">Monitoring progress implementasi kurikulum berbasis Outcome-Based Education untuk Program Studi Anda</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 mb-8">
            <div class="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
                ...
                <!-- Export Section -->
                <form action="{{ route('kaprodi.export.excel') }}" method="GET" class="flex-1">
        ...
        @else
            ...
            <div class="bg-white rounded-xl shadow-lg p-12 text-center">
                ...
                <p class="mt-2 text-sm text-gray-500 max-w-md mx-auto">
                    Silakan pilih tahun kurikulum di bawah untuk menampilkan progress implementasi OBE untuk program studi Anda.
                </p>
                
                <!-- Year Filter Form -->
                <form method="GET" action="{{ route('kaprodi.dashboard') }}" class="mt-6 max-w-sm mx-auto">
