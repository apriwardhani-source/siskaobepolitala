...
@section('content')
    <div class="mr-20 ml-20">
        <h2 class="text-4xl text-center font-extrabold mb-4">Edit Catatan</h2>
        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
            ...
            <form action="{{ route('kaprodi.notes.update', $note->id_note) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="mb-4">
                    ...
                    <input type="text" value="{{ $note->prodi->nama_prodi }}" readonly
                        class="w-full p-3 border border-gray-300 rounded-lg bg-gray-100 text-gray-600">
                    <input type="hidden" name="kode_prodi" value="{{ $note->kode_prodi }}">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="title" name="title" value="{{ old('title', $note->title) }}"
                        class="w-full p-3 border border-gray-300 rounded-lg mt-1 mb-3 focus:outline-none focus:ring-2 focus:ring-green-500"
