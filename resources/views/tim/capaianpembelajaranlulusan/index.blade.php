            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200">
                ...
                <div class="px-6 py-5 border-b border-gray-200 bg-white">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
                        <h2 class="text-lg font-semibold text-gray-900">Daftar CPL Program Studi</h2>
                        ...
                        <div class="sm:w-80">
                            <div class="relative">
                                ...
                                <input type="text" id="search" placeholder="Cari CPL..."
                ...
                @if ($capaianpembelajaranlulusans->isEmpty())
                    ...
                    <div class="px-6 py-16 text-center">
                        ...
                        <p class="mt-2 text-sm text-gray-500 max-w-md mx-auto">
                            Belum ada Capaian Profil Lulusan untuk program studi Anda. Klik tombol "Tambah CPL" untuk
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gradient-to-r from-gray-700 to-gray-800">
                                <tr>
                                    <th scope="col"
                                        class="px-4 py-4 text-center text-xs font-semibold text-gray-100 uppercase tracking-wider w-16">
                                        No</th>
                                    <th scope="col"
                                        class="px-4 py-4 text-center text-xs font-semibold text-gray-100 uppercase tracking-wider w-32">
                                        Kode Cpl</th>
                                    <th scope="col"
                                        class="px-4 py-4 text-left text-xs font-semibold text-gray-100 uppercase tracking-wider">
                                        Deskripsi CPL</th>
                                    <th scope="col"
                                        class="px-4 py-4 text-center text-xs font-semibold text-gray-100 uppercase tracking-wider w-40">
                                        Aksi</th>
                                </tr>
                            </thead>
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach ($capaianpembelajaranlulusans as $index => $cpl)
                                    <tr
                                        ...
                                        <td
                                            class="px-4 py-4 whitespace-nowrap text-center text-sm text-gray-700 font-medium">
                                            {{ $index + 1 }}
                                        </td>
                                        ...
                                        <td class="px-4 py-4 whitespace-nowrap text-center text-sm">
                                            <div class="flex justify-center space-x-2">
                                                ...
                                                <form
                                                    action="{{ route('tim.capaianpembelajaranlulusan.destroy', $cpl->id_cpl) }}"
