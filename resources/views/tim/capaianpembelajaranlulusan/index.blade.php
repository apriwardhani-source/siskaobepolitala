            ...
            @if ($capaianpembelajaranlulusans->isEmpty())
                ...
                <div class="px-6 py-16 text-center">
                    ...
                    <p class="mt-2 text-sm text-gray-500 max-w-md mx-auto">
                        Belum ada Capaian Profil Lulusan untuk program studi Anda. Klik tombol "Tambah CPL" untuk menambahkan data baru.
                    </p>
                    <div class="mt-6">
                        <a href="{{ route('tim.capaianpembelajaranlulusan.create') }}" 
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gradient-to-r from-gray-700 to-gray-800">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-4 text-left text-xs font-semibold text-gray-100 uppercase tracking-wider">Deskripsi CPL</th>
                            ...
                            <tr class="hover:bg-blue-50 transition-colors duration-150 {{ $index % 2 == 0 ? 'bg-white' : 'bg-gray-50' }}">
                                ...
                                <td class="px-4 py-4 whitespace-nowrap text-center text-sm">
                                    <div class="flex justify-center space-x-2">
                                        ...
                                        <form action="{{ route('tim.capaianpembelajaranlulusan.destroy', $cpl->id_cpl) }}" method="POST" class="inline">
                                            @csrf @method('DELETE')
                                            <button type="submit" 
