                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-600">
                            Matriks pemetaan CPL → CPMK → Mata Kuliah untuk program studi Anda.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200 mb-8">
                <div class="bg-blue-600 px-6 py-4">
                    <h2 class="text-xl font-bold text-white flex items-center">
                        <i class="fas fa-filter mr-2"></i>Filter Pemetaan MK - CPL - CPMK
                    </h2>
                </div>
                <div class="p-6">
                    <form method="GET" action="{{ route('tim.pemetaancplcpmkmk.pemetaanmkcplcpmk') }}" class="space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div class="flex items-end space-x-3">
                                ...
                                {{-- Tempat untuk tombol Export Excel jika nanti ada route tim.export.pemetaan --}}
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200">
                ...
                <div class="px-6 py-4 bg-gradient-to-r from-blue-50 to-indigo-50 border-b border-blue-100">
                    <div class="flex items-start">
                        ...
                        <div class="flex-1">
                            <p class="text-sm text-blue-900 font-medium">Matriks Pemetaan Interaktif</p>
                            <p class="text-xs text-blue-700 mt-1">Hover pada kode CPL atau CPMK untuk melihat deskripsi
                                lengkap. Tabel menampilkan relasi antara Mata Kuliah dan Capaian Pembelajaran.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gradient-to-r from-[#1e3c72] to-[#2a5298] sticky top-0 z-10">
                                <tr>
                                    <th
                                        class="px-4 py-4 text-center text-xs font-semibold text-gray-100 uppercase tracking-wider border-r border-[#2a5298] w-32">
                                    ...
                                    <th
                                        class="px-4 py-4 text-center text-xs font-semibold text-gray-100 uppercase tracking-wider border-r border-[#2a5298]">
                                        <div class="flex items-center justify-center">
                                    ...
                                    @foreach ($semuaCpl as $cpl)
                                        <th
                                            class="px-4 py-4 text-center text-xs font-semibold text-gray-100 uppercase tracking-wider border-r border-[#2a5298] relative group cursor-pointer">
                                            <div class="flex items-center justify-center">
                                                <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                                    <path fill-rule="evenodd"
                                            ...
                                            <div
                                                class="absolute left-1/2 -translate-x-1/2 top-full mt-2 hidden group-hover:block w-72 bg-gray-900 text-white text-sm rounded-lg p-4 z-50 shadow-2xl border border-gray-700">
                                                <div class="bg-gray-800 rounded px-3 py-2 mb-2">
                                                    <strong class="text-blue-300">{{ $cpl->nama_prodi ?? '-' }}</strong>
                                                </div>
                                                <div class="text-justify text-gray-200 leading-relaxed">
                                                    {{ $cpl->deskripsi_cpl ?? '-' }}
                                                </div>
                                            </div>
                                        </th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach ($matrix as $kodeMk => $mk)
                                    <tr class="hover:bg-blue-50 transition-colors duration-150">
                                        <td class="px-4 py-3 border-r border-gray-200 align-top text-center">
                                            <span
                                                class="inline-flex items-center px-2 py-1 rounded text-xs font-semibold bg-purple-100 text-purple-800">
                                                {{ $kodeMk }}
                                            </span>
                                        </td>
                                        <td class="px-4 py-3 border-r border-gray-200 align-top text-sm text-gray-900">
                                            {{ $mk['nama'] }}
                                        </td>
                                        @foreach ($semuaCpl as $cpl)
                                            <td class="px-4 py-3 border-r border-gray-200 text-center align-top">
                                                    ...
                                                    <div class="flex flex-col gap-1">
                                                        @foreach ($mk['cpl'][$cpl->kode_cpl]['cpmks'] as $kodeCpmk)
                                                            <div class="group inline-block relative cursor-pointer">
                                                                <span
                                                                    class="inline-flex items-center px-2 py-1 rounded text-xs font-semibold bg-blue-100 text-blue-800 hover:bg-blue-200 transition-colors">
                                                                    {{ $kodeCpmk }}
                                                                </span>
                                                                <div
                                                                    class="absolute left-1/2 -translate-x-1/2 top-full mt-2 hidden group-hover:block w-72 bg-gray-900 text-white text-sm rounded-lg p-4 z-50 shadow-2xl border border-gray-700">
                                                                    <div class="bg-gray-800 rounded px-3 py-2 mb-2">
                                                                        <strong
                                                                            class="text-green-300">{{ $mk['cpl'][$cpl->kode_cpl]['cpmk_details'][$kodeCpmk]['nama_prodi'] ?? '-' }}</strong>
                                                                    </div>
                                                                    <div
                                                                        class="text-justify text-gray-200 leading-relaxed">
