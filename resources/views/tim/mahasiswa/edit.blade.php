...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-6 px-4 sm:px-6 lg:px-8">
    <div class="max-w-4xl mx-auto">
        ...
        <!-- Header -->
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900 tracking-tight">Edit Mahasiswa</h1>
            <p class="mt-2 text-sm text-gray-600">Perbarui data mahasiswa</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
            ...
            <form action="{{ route('tim.mahasiswa.update', $mahasiswa->id) }}" method="POST" class="p-6">
                @csrf
                @method('PUT')
