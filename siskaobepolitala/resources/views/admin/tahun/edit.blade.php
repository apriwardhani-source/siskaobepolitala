    ...
    <div class="max-w-5xl mx-auto">
        ...
        <div class="mb-6">
            ...
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h1 class="text-2xl md:text-3xl font-bold text-gray-900 tracking-tight">Edit Tahun Kurikulum</h1>
                    <p class="mt-1 text-sm text-gray-600">
                        Perbarui informasi tahun ajaran dan nama kurikulum yang digunakan.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="px-6 py-6">
                ...
                <form action="{{ route('admin.tahun.update', $tahun->id_tahun) }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- Kolom Kiri -->
                        <div class="space-y-2">
                            <label for="tahun" class="block text-sm font-semibold text-gray-800">
                                Tahun Ajaran
                            </label>
                            <input
                                type="number"
                                id="tahun"
                                name="tahun" 
                                class="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white"
                        ...
                        <!-- Kolom Kanan -->
                        <div class="space-y-2">
                            <label for="nama_kurikulum" class="block text-sm font-semibold text-gray-800">
                                Nama Kurikulum
                            </label>
                            <input
                                type="text"
                                ...
                                value="{{ old('nama_kurikulum', $tahun->nama_kurikulum) }}"
                                required
                            >
                        </div>
                    </div>
