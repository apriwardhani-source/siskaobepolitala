        ...
        <div class="mb-8">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="mt-4 md:mt-0">
                    <a href="{{ route('admin.ranking.export', $session->id_session) }}" 
                       class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 inline-flex items-center text-sm font-semibold shadow-md">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                  d="M12 10v6m0 0l-3-3m3 3 3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414A1 1 0 0119 9.414V19a2 2 0 01-2 2z" />
                        </svg>
                        Export Excel
                    </a>
                </div>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-blue-50 transition-colors {{ $rank->ranking <= 3 ? 'bg-yellow-50' : '' }}">
                            ...
                            <td class="px-6 py-4 text-center">
                                <a href="{{ route('admin.ranking.detail', [$session->id_session, $rank->nim]) }}" 
