                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="kode_prodi" name="kode_prodi" required>
                        ...
                        @foreach($prodis as $prodi)
                            <option value="{{ $prodi->kode_prodi }}" {{ old('kode_prodi', $mahasiswa->kode_prodi) == $prodi->kode_prodi ? 'selected' : '' }}>
                                {{ $prodi->nama_prodi }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="id_tahun_angkatan" name="id_tahun_angkatan" required>
                        ...
                        @foreach($tahun_angkatans as $tahun)
                            <option value="{{ $tahun->id_tahun }}" {{ old('id_tahun_angkatan', $mahasiswa->id_tahun_angkatan) == $tahun->id_tahun ? 'selected' : '' }}>
                                {{ $tahun->tahun }}
                            </option>
                        @endforeach
                    </select>
