      ...
      <div class="flex items-center space-x-4">
        ...
        <div>
          ...
          <p class="mt-1 text-sm text-gray-600">
            Informasi lengkap tentang Sub CPMK {{ $subcpmk->sub_cpmk ?? '-' }} pada CPMK {{ optional($subcpmk->CapaianPembelajaranMataKuliah)->kode_cpmk ?? '-' }}.
          </p>
        </div>
      </div>
    </div>
      ...
      <div class="px-8 py-6 space-y-6">
        ...
        <div>
          ...
          <div class="w-full bg-gray-50 border border-gray-300 rounded-lg px-4 py-3">
            @php $kodeCpmk = optional($subcpmk->CapaianPembelajaranMataKuliah)->kode_cpmk; @endphp
            @if($kodeCpmk)
        ...
        <div>
          ...
          <div class="w-full bg-gray-50 border border-gray-300 rounded-lg px-4 py-3 text-gray-700 min-h-[80px]">
            {{ optional($subcpmk->CapaianPembelajaranMataKuliah)->deskripsi_cpmk ?? '-' }}
          </div>
        </div>
