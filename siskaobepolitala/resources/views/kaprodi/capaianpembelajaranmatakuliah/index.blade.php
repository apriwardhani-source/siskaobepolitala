        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200">
            ...
            <div class="bg-blue-600 px-6 py-4 flex items-center justify-between text-white">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <h2 class="text-lg font-bold">Filter CPMK</h2>
                        <p class="text-xs text-blue-100">Pilih tahun kurikulum dan cari CPMK berdasarkan kata kunci.</p>
                    </div>
                </div>
            </div>
            ...
            <!-- Content -->
            @if($capaianpembelajaranmatakuliahs->isEmpty())
                <!-- Empty State -->
                <div class="px-6 py-16 text-center">
                    ...
                    <p class="mt-2 text-sm text-gray-500 max-w-md mx-auto">
                        ...
                        Hubungi Tim Penyusun Kurikulum untuk menambahkan data CPMK.
                    </p>
                </div>
            @else
                <!-- Table -->
...
function updateFilter() {
    ...
    let url = "{{ route('kaprodi.capaianpembelajaranmatakuliah.index') }}";
