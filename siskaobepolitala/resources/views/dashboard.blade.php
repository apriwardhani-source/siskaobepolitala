...
@section('content')
    ...
    <div class="mt-4 d-grid gap-3" style="grid-template-columns: repeat(auto-fit, minmax(250px, 1fr));">
        @if(Auth::user()->role === 'admin')
            <!-- Card untuk Admin -->
            <a href="{{ route('admin.manage.users') }}" class="glass-card-link">
                <div class="glass-card">
                    <h3>Kelola Akun</h3>
        ...
        @elseif(Auth::user()->role === 'akademik')
            ...
            <a href="{{ route('akademik.cpl') }}" class="glass-card-link">
                <div class="glass-card">
                    <h3>Kelola CPL</h3>
                    <p>Tambah, edit, atau hapus Capaian Pembelajaran Lulusan.</p>
                </div>
            </a>
            <a href="{{ route('akademik.cpmk') }}" class="glass-card-link">
                <div class="glass-card">
                    <h3>Kelola CPMK</h3>
                    <p>Tambah, edit, atau hapus CPMK untuk mata kuliah.</p>
                </div>
            </a>
            <a href="{{ route('akademik.mapping') }}" class="glass-card-link">
                <div class="glass-card">
        ...
        @elseif(Auth::user()->role === 'kaprodi')
            <!-- Card untuk Kaprodi -->
            <a href="{{ route('kaprodi.laporan.mk') }}" class="glass-card-link">
                <div class="glass-card">
                    <h3>Laporan CPL per MK</h3>
                    <p>Lihat capaian CPL untuk setiap mata kuliah.</p>
                </div>
            </a>
            <a href="{{ route('kaprodi.laporan.angkatan') }}" class="glass-card-link">
                <div class="glass-card">
        ...
        @elseif(Auth::user()->role === 'wadir')
            <!-- Card untuk Wadir I -->
            <a href="{{ route('wadir.laporan.cpl.lintasprodi') }}" class="glass-card-link">
                <div class="glass-card">
                    <h3>Laporan Agregat CPL</h3>
                    <p>Lihat ringkasan capaian CPL secara keseluruhan lintas program studi.</p>
                </div>
            </a>
            <a href="{{ route('wadir.generate.laporan') }}" class="glass-card-link">
                <div class="glass-card">
        ...
        @else
            ...
            <div class="glass-card">
                ...
                <p>Role Anda saat ini: {{ Auth::user()->role }}. 
                   Fitur untuk role ini sedang dalam pengembangan.</p>
            </div>
        @endif
    </div>
@endsection
