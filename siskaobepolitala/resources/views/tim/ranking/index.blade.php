...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-6 px-4 sm:px-6 lg:px-8">
    <div class="max-w-7xl mx-auto">
            ...
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="mt-2 text-sm text-gray-600">
                        Upload data nilai mahasiswa dan sistem akan menghitung ranking menggunakan metode Simple Additive Weighting (SAW)
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200 mb-8">
            ...
            <form action="{{ route('tim.ranking.hitung') }}" method="POST" class="p-6">
                @csrf
                                ...
                                @foreach($groupedMK as $semester => $mks)
                                    <div class="mb-4">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
                                            @foreach($mks as $mk)
                                                <label class="flex items-start p-3 border border-gray-200 rounded-lg hover:bg-white hover:border-blue-300 cursor-pointer transition-all">
                            ...
                            <tr class="hover:bg-blue-50 transition-colors duration-150 {{ $index % 2 == 0 ? 'bg-white' : 'bg-gray-50' }}">
                                ...
                                <td class="px-6 py-4 text-center">
                                    <div class="flex justify-center space-x-2">
                                        <a href="{{ route('tim.ranking.hasil', $session->id_session) }}" 
                                        ...
                                        <form action="{{ route('tim.ranking.destroy', $session->id_session) }}" method="POST" 
