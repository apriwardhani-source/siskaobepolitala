...
<div class="mx-20 mt-6">
    ...
    <div class="bg-blue-50 border border-blue-300 rounded-lg p-4 mb-6">
        <div class="flex justify-between items-center mb-2">
            ...
            <a href="{{ route('tim.capaianpembelajaranlulusan.import.template') }}" 
    ...
    <form action="{{ route('tim.capaianpembelajaranlulusan.import.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
