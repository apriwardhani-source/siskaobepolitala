...
class SubCpmkExport implements FromCollection, WithHeadings, WithTitle, WithStyles
{
    public function __construct(private $idTahun = null, private $kodeProdi = null) {}

    public function collection()
    {
        $q = DB::table('sub_cpmks as sub')
            ...
            ->select('cpmk.kode_cpmk','sub.sub_cpmk','sub.uraian_cpmk','prodis.nama_prodi','tahun.tahun');
        ...
        return $rows->map(fn($r,$i)=>[
            ...
            'sub_cpmk'=>$r->sub_cpmk,
            'uraian'=>$r->uraian_cpmk,
            'prodi'=>$r->nama_prodi,
            'tahun'=>$r->tahun,
        ]);
    }

    public function headings(): array { return ['No','Kode CPMK','Sub CPMK','Uraian','Program Studi','Tahun']; }
    public function title(): string { return 'SubCPMK'; }
