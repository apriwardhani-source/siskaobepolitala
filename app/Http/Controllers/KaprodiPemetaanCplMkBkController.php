...
class KaprodiPemetaanCplMkBkController extends Controller
{
    public function index()
    {
        ...
        return view('kaprodi.pemetaancplmkbk.index', compact('cpls', 'bks', 'matrix', 'prodi', 'prodiByCpl', 'id_tahun', 'tahun_tersedia'));
    }
}
