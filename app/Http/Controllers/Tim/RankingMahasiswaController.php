...
class RankingMahasiswaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('tim.ranking.index', compact('sessions', 'tahun_tersedia', 'mataKuliahs'));
    }
    ...
    public function hitungRanking(Request $request)
    {
        ...
        try {
            ...
            return redirect()
                ->route('tim.ranking.hasil', $session->id_session)
    ...
    public function hasil($id_session)
    {
        ...
        return view('tim.ranking.hasil', compact('session', 'rankings', 'kriteria'));
    }
    ...
    public function detail($id_session, $nim)
    {
        ...
        return view('tim.ranking.detail', compact('session', 'detail'));
    }
